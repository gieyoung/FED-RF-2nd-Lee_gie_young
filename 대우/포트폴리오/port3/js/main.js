...
$(function(){
	...
	// 누를때마다 불나오게 
		...
		$('.m6').click(function(){
			$("body,html").animate({'scrollTop':6500},800);
		});
		$('.m7').click(function(){
			$("body,html").animate({'scrollTop':8000},800);
		});
...
//포트폴리오 박스 호버
 ...
 //포트폴리오 박스 호버2
 		...
 		$('.port2 .g_box li').mouseenter(function(){
 			$(this).find('.cover2').stop().fadeIn(500);
 		});
 		$('.port2 .g_box li').mouseleave(function(){
 			$(this).find('.cover2').stop().fadeOut(500);
 		});
