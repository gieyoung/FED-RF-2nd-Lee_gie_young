...
// 이벤트 대상 선택변경시 실제 정렬을 적용하여 리스트를 갱신한다.
// 정렬 적용시 정렬기준 대상 선택 항목을 가져가야 함
// 정렬기준 대상 선택 변경시
// 이벤트 대상 선택 초기화하기("정렬선택"으로 변경)


mFn.addEvt(sel3,"change",(e)=>
  sortingFn(e, cta3.value, list1, showList3));
